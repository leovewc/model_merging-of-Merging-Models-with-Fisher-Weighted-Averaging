...
flags.DEFINE_string('glue_task', 'sst2', 'GLUE task name')
flags.DEFINE_string('use_auth_token', None, 'Hugging Face access token if needed')

flags.DEFINE_bool("from_pt", True, "Whether to load from PyTorch checkpoint")
flags.DEFINE_string("split", "validation", "Dataset split to use")
flags.DEFINE_integer("n_examples", 4096, "Number of examples to use")
...
flags.DEFINE_integer("n_coeffs", 51, "Number of coefficients to search")
flags.DEFINE_enum("coeff_mode", "grid", ["grid", "random"], "Coefficient search mode")

flags.DEFINE_float("fisher_floor", 1e-6, "Minimum Fisher information value")
flags.DEFINE_bool("favor_target_model", True, "Whether to favor target model in merging")
flags.DEFINE_bool("normalize_fishers", True, "Whether to normalize Fisher information")
